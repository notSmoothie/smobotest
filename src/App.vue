                ...
                >
                    <v-container class="text-center">
                        <v-responsive class="mx-auto" width="500">
                            ...
                            <h3 class="text-h3">Try the new Vuetify</h3>

                            <p class="mt-4 text-medium-emphasis">
                                This is a basic Vuetify 3 application designed
                                to help get your feet wet with the next version
                                of the framework. Visit our
                                <a
                        ...
                        <v-row justify="space-between">
                            <v-col cols="auto">
                                <v-responsive width="350">
                                    ...
                                    <p class="mt-8">
                                        Vuetify 3 has an unprecedented level of
                                        customization options that make
                                        implementing any design system easy.
                                    </p>

                                    <p class="mt-8">
                                        Assign default values for all components
                                        in the library, including nested
                                        support.
                                    </p>
                        ...
                        <v-row justify="space-between">
                            <v-col cols="auto">
                                <v-responsive width="350">
                                    ...
                                    <p class="mt-3">
                                        Vuetify 3 uses the Vue composition API
                                        to build easy-to-use and feature rich
                                    ...
                                    <p class="mt-8">
                                        ...
                                        <strong>use functions</strong> that
                                        follow the Vue 3 nomenclature and code
                                        styling.
                                    </p>
                        ...
                        <v-row justify="space-between">
                            <v-col cols="auto">
                                <v-responsive width="350">
                                    ...
                                    <p class="mt-3">
                                        The latest version is almost here. Use
                                        one of our free themes to get a head
                                        start!
                                    </p>

                                    <p class="mt-8">
                                        This theme is designed to demonstrate a
                                        basic single page application using
                                        Vuetify 3.
                                    </p>
                        ...
                        <v-row justify="space-between">
                            <v-col cols="auto">
                                ...
                                >
                                    ...
                                    <p class="mt-8">
                                        Vuetify is free to use software under
                                        the
                                        <a
                                            ...
                                            >MIT</a
                                        >
                                        License and requires an extensive amount
                                        of time to maintain. Supporting
                                        development ensures Vuetify will be
                                        actively maintained.
                                    </p>
